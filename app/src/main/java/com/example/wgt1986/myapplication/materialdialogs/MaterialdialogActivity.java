...
import com.example.wgt1986.myapplication.materialdialogs.color.CircleView;
import com.example.wgt1986.myapplication.materialdialogs.color.ColorChooserDialog;
import com.example.wgt1986.myapplication.materialdialogs.folderselector.FileChooserDialog;
import com.example.wgt1986.myapplication.materialdialogs.folderselector.FolderChooserDialog;
import com.example.wgt1986.myapplication.materialdialogs.internal.MDTintHelper;
import com.example.wgt1986.myapplication.materialdialogs.internal.ThemeSingleton;
import com.example.wgt1986.myapplication.materialdialogs.simplelist.MaterialSimpleListAdapter;
import com.example.wgt1986.myapplication.materialdialogs.simplelist.MaterialSimpleListItem;
import com.example.wgt1986.myapplication.materialdialogs.util.DialogUtils;
 ...
 */
public class MaterialdialogActivity extends AppCompatActivity implements
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(R.layout.activity_main_materdialog);
  ...
  public void showLongList() {
    new MaterialDialog.Builder(this).title(R.string.states)
  ...
  public void showFileChooser() {
    ...
    if (ActivityCompat
        .checkSelfPermission(MaterialdialogActivity.this, Manifest.permission.READ_EXTERNAL_STORAGE) !=
        PackageManager.PERMISSION_GRANTED) {
      ActivityCompat.requestPermissions(MaterialdialogActivity.this,
  ...
  public void showFolderChooser() {
    ...
    if (ActivityCompat
        .checkSelfPermission(MaterialdialogActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) !=
        PackageManager.PERMISSION_GRANTED) {
      ActivityCompat.requestPermissions(MaterialdialogActivity.this,
  ...
  public void showInputDialog() {
    new MaterialDialog.Builder(this)
        ...
        .input(R.string.input_hint, R.string.input_hint, false, (dialog, input) ->
            showToast("Hello, " + input.toString() + "!")).show();
  }
